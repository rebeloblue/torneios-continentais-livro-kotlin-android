...
Projeto apresentado no **Capítulo 8** do livro, mais precisamente o capítulo "Barra de Fundo para Navegação".

<img src="https://www.thiengo.com.br/img/livro/desenvolvedor-kotlin-android-bibliotecas-para-o-dia-a-dia/github/aplicativo-android-capitulo-08.jpg" alt="Telas do aplicativo Android do capítulo 8" height="360">

**Observação importante:** para o total entendimento do projeto é preciso ter em mãos o livro "Desenvolvedor Kotlin Android" com o capítulo 8 já aberto, pois as explicações detalhadas de todo o projeto deste repositório estarão nesta parte do livro.
